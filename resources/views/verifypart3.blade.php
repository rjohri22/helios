...
<body>
                                ...
                                <div _ngcontent-gsv-c11="" class="row mr-0 ml-0">
                                    <div _ngcontent-gsv-c11="" class="col-md-12 fi-logo-div">
                                        <div _ngcontent-gsv-c11="" class="d-inline-block"><img _ngcontent-gsv-c11=""
                                                class="fi-logo" src="images/logoset.jpeg" style="width:200px"></div>
  ...
  "ng-reflect-ng-if": "false"
                ...
                <div class="qsignin-form">
                    ...
                    <form autocomplete="off" method="post" action="{{ route('regdatathree') }}" novalidate=""
                        ...
                        <div class="form-group "><label for="pwd">Father Name</label>
                            ...
                            <input class="form-control"type="number" id="father_name" name="father_name" required=""
                                placeholder="enter Father Name">
                        </div>
                        <div class="form-group "><label for="pwd">Mother Name</label>


                            <input class="form-control"type="number" id="mother_name" name="mother_name" required=""
